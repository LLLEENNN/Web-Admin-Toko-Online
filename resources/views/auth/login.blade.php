@extends('layouts.auth', ['title' => 'Login - Anggit Elektronik'])
    ...
    <div class="flex justify-center items-center h-screen bg-gray-300 px-6">
        ...
        <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
            <div class="flex justify-center items-center">
                <span class="text-gray-400 font-semibold text-2xl">Login Admin</span>
            </div>
            <div class="flex justify-center items-center">
                <span class="text-gray-700 font-semibold text-2xl">Anggit Elektronik</span>
            </div>
            @if (session('status'))
