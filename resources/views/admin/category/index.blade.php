@extends('layouts.app', ['title' => 'Kategory - Admin'])
                    ...
                    <table class="min-w-full table-auto">
                        <thead class="justify-between">
                            <tr class="bg-gray-600 w-full">
                                {{-- <th class="px-16 py-2">
                                    <span class="text-white">Kode Kategori</span>
                                </th>
                                <th class="px-16 py-2">
                                    <span class="text-white">Kode Dept</span>
                                </th> --}}
                        ...
                        <tbody class="bg-gray-200">
                            @forelse($categories as $category)
                                <tr class="border bg-white">
                                    ...
                                    <td class="px-5 py-2">
                                        <img class=" object-cover" width="64" height="64" src="{{ $category->image }}">
                                    </td>
