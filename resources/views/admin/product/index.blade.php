@extends('layouts.app', ['title' => 'Produk - Admin'])
        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="flex items-center">
                ...
                {{-- <button class="text-white ml-4 focus:outline-none bg-green-600 px-4 py-2 shadow-sm rounded-md">
                    <a href="{{ route('import_update') }}">Update Data</a>
                </button> --}}
                    ...
                    <table class="min-w-full table-auto">
                        <thead class="justify-between">
                            <tr class="bg-gray-600 w-full">
                                {{-- <th class="px-16 py-2">
                                    <span class="text-white">Kode Produk</span>
                                </th> --}}
                                ...
                                <tr class="border bg-white">
                                    ...
                                    <td class="px-10 py-2 text-center">
                                        ...
                                        <button onClick="destroy(this.id)" id="{{ $product->id }}"
                                            class="bg-red-600 mt-3 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                                    </td>
                                </tr>
                            @empty
