@extends('layouts.app', ['title' => 'Kode Voucher - Admin'])
        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="flex items-center">
                <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                    <a href="{{ route('admin.voucher.create') }}">Tambah Promo Voucher</a>
                </button>
                {{-- <button class="text-white ml-4 focus:outline-none bg-green-600 px-4 py-2 shadow-sm rounded-md">
                    <a href="{{ route('import_category') }}">Import Data</a>
                </button> --}}
                ...
                <div class="inline-block min-w-full shadow-sm rounded-lg overflow-hidden">
                    <table class="min-w-full table-auto">
                        <thead class="justify-between">
                            <tr class="bg-gray-600 w-full">
                                ...
                                <th class="px-16 py-2 text-left">
                                    <span class="text-white">Min Order </span>
                                </th>
                                <th class="px-16 py-2">
                    ...
                    @if ($vouchers->hasPages())
                        <div class="bg-white p-3">
                            {{ $vouchers->links('vendor.pagination.tailwind') }}
                        </div>
                    @endif
                </div>
            </div>
